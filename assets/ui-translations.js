(function () {
  var textTranslations = new Map([
    ...
    ["Entrenadores certificados", "Coaches expertos"],
    ["Nuestros coaches cuentan con certificaciones de alto nivel y años de experiencia real.", "Experiencia real y formación especializada en cada sesión."],
